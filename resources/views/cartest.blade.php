               ...
               <div class="card-content p-6">
                   ...
                   <div class="card-details space-y-3">
                       ...
                       <div class="flex items-center gap-4 text-white-600">
                            <span class="border-2 border-blue-600 bg-blue-600 text-white rounded-md px-2 py-1">Modified</span>
                            <span class="border-2 border-blue-600 rounded-md px-2 py-1">2009</span>
                            <span class="border-2 border-blue-600 rounded-md px-2 py-1">Manual</span>
                            <span class="border-2 border-blue-600 rounded-md px-2 py-1">150 km</span>
                        </div>
                       <h4>Davao Del Sur</h4>
                       ...
                       <div class="flex space-x-4 w-full max-w-md">
                            <button class="border-2 border-blue-600 rounded-md p-2 text-blue-600 hover:bg-blue-200 transition duration-200 flex-1">
                                <span class="text-sm">Make an Offer</span>
                            </button>
                            <button class="bg-blue-600 text-white p-2 rounded-md flex-1">
