...
<body>
<<<<<<< HEAD
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 ml-2">
                ...
                <div class="card-content p-6">
                    ...
                    <div class="card-details space-y-3">
                        ...
                        <div class="flex items-center gap-4 text-white-600">
                            ...
                            <span class="border-2 border-white-800 rounded-md px-1 py-1 ">2009</span>
                            <span class="border-2 border-white-800 rounded-md px-1 py-1">Manual</span>
                            <span class="border-2 border-white-800 rounded-md px-1 py-1">150 km</span>
=======
