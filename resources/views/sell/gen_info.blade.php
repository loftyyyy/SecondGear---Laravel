    ...
    <h1 class="text-3xl font-bold mb-6">Car Details</h1>
        <div class="p-4 grid grid-cols-3 gap-10 w-10/12">
            <div>
                ...
                <input type="text" name="brand_other" id="brand_other" placeholder="If other, please specify" class="mt-2 w-full text-black border border-gray-300 rounded-md p-2 hidden">
            </div>
