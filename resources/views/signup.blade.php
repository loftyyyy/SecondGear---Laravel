        ...
        <div class="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
            <div class="w-full">
                ...
                <form class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                    ...
                    <p class="mt-6 text-sm text-center text-gray-400">Already have an account? <a href="{{route('authentications.login')}}" class="text-blue-500 focus:outline-none focus:underline hover:underline">Log in</a></p>
                </form>
            </div>
        </div>
    </div>
